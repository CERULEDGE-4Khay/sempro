...
<aside
  ...
  <div class="h-19.5">
    ...
    <a
      ...
      target="_blank">
      <span
        class="ml-1 font-semibold text-slate-900 transition-all duration-200 ease-nav-brand"
        >Absensi Magang</span
      >
    </a>
  </div>
  ...
  <div
    class="items-center block w-auto h-full overflow-auto grow basis-full">
